					...
					<table class="sched">
						...
						<tbody class="sched">
							<tr>
								...
								<td>${schedData?.curZoneTemp}°${state?.tempUnit}</td>
							</tr>
						</tbody>
					</table>
					<table class="sched">
						...
						<tbody>
							<tr>
								<td>${schedData?.reqSenHeatSetPoint ? "${schedData?.reqSenHeatSetPoint}°${state?.tempUnit}": "Not Available"}</td>
								<td>${schedData?.reqSenCoolSetPoint ? "${schedData?.reqSenCoolSetPoint}°${state?.tempUnit}": "Not Available"}</td>
							</tr>
						</tbody>
					</table>
				</section>
